...
void loop() {
  ...
  if (millis() - lastToggle > 5000) {
    ...
    snprintf(json, sizeof(json),
      ...
      "  \"room\": \"WorkRoom1\",\n"
      "  \"devices\": [\n"
      "    { \"deviceId\": \"work1-fan-1\",   \"status\": \"%s\" },\n"
      "    { \"deviceId\": \"work1-fan-2\",   \"status\": \"%s\" },\n"
      "    { \"deviceId\": \"work1-light-1\", \"status\": \"%s\" },\n"
      "    { \"deviceId\": \"work1-light-2\", \"status\": \"%s\" },\n"
      "    { \"deviceId\": \"work1-light-3\", \"status\": \"%s\" }\n"
      "  ],\n"
      "  \"currentAmps\": %.2f,\n"
      "  \"totalWatts\": %.2f\n"
      "}",
